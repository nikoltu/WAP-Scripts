...
echo"<br/>
-<br/>
<input name=\"topic\" type=\"text\" maxlength=\"10\" title=\"Topicas\"/><br/>
<anchor>$iconas Keisti<go href=\"icon.php?nick=$nick&amp;pass=$pass&amp;id=keiciu\" method=\"post\">
...
{
echo"<p align=\"left\"><small>Iconai pakeisti!<br/>
$lin<br/>
<a href=\"zaisti.php?nick=$nick&amp;pass=$pass&amp;id=\">$iconas Zaidimas</a><br/></small></p>";


$fpa = fopen("txt/icons/$nick.txt","w");
fwrite($fpa, "$topic");
fclose($fpa);
}
 }
