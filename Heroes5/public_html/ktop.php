...
$on = mysql_query("SELECT username, kred FROM users ORDER by kred DESC LIMIT $limit, 20");
$top = 0;
...
if ($pages > $page + 1) {
   $pager = $page + 1;
   echo"<small><a href=\"index.php?action=ktop&amp;id=$id&amp;page=$pager\">$next</a></small><br/>";
}
if ($page > 0) {
   $pager = $page - 1;
   echo"<small><a href=\"index.php?action=ktop&amp;id=$id&amp;page=$pager\">$back</a></small><br/>";
}
$page++;
