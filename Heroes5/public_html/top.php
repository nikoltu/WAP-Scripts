...
$pl = mysql_num_rows(mysql_query("SELECT * FROM users WHERE deleted='0' and level>$user[level]")) + 1;
...
$page++;
echo"<small><u>Puslapis: $page/$pages</u></small><br/><small><u>Viso heroj&#371;: $count</u></small><br/>$line<br/><small><i>Nurodoma vieta, vardas ir turimas lygis.</i></small><br/>$line<br/><small><a href=\"index.php?id=$id\">$home</a></small>";
?>