<?
$bld=@file_get_contents("sp/bloodlust/$battle[heroe].txt");
if($magi){
...
@file_put_contents("sp/bloodlust/$battle[heroe].txt","$eji");
$who=$turn[1]-1;
echo"<small>Panaudojai $magic_name[$magi].</small>";}}
}
if(0<$bld){
$atk=3;
if(($user[identify]=="ash") or ($user[identify]=="inteus")){
$atk=$atk+1;}
include_once("skils/fire_magic.php");
$army_attack[$who]=$army_attack[$who]+$atk;
$bld=$bld-1;
@file_put_contents("sp/bloodlust/$battle[heroe].txt","$bld");
}
