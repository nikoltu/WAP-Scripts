...
$pl = mysql_num_rows(mysql_query("SELECT * FROM users WHERE atve>$user[atve]")) + 1;
echo"<small><b><u>Heroj&#371; TOP</u></b></small><br/>$line<br/><small>J&#363;s u&#382;imate <b>$pl</b> viet&#261;.</small><br/>$line</p><p align=\"left\">";
$on = mysql_query("SELECT username, atve FROM users order by atve desc LIMIT $limit, 20");
$top = 0;
