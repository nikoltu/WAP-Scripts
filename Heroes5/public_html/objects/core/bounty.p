...
if (($d[0] >= $inf[1]) and ($inf[3] >= $time)) {
   ...
   if (($gi1 > 0) and ($gi2 > 0)) {
      ...
      echo"$line<br/><small><b>J&#363;s &#303;vykd&#279;te u&#382;duot&#303;!</b></small><br/><small><u>Gavote patirties: $exp</u></small><br/>$line<br/><small><u>Gavote $go aukso!</u></small><br/><img src=\"img/resources/gold.gif\" alt=\"Auksas\"/><br/>";
   }
   else {
