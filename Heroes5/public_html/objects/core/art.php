...
$ag=mt_rand(1, count($art)) -1;
$mob=$art[$ag];
$mob2=$ter[$ag];
include_once("names/units.php");
$uname=$unit_name_p2[$mob];
include_once("names/territories2.php");
$tname=$territory2_name[$mob2];
      echo"$line<br/><small><b>J&#363;s &#303;vykd&#279;te u&#382;duot&#303;!</b></small><br/><small><u>Artifakta galima gauti kovojant su $uname $tname teritorijoje</u></small><br/>";}
else {
   $ttime = $inf[3] - $time;
   if ($d[0] == "") { $d[0] = 0; }
